...
object GuardaSerieProvider : Provider {
    ...
    override val logo: String get() = "$baseUrl/wp-content/uploads/2026/06/Guardoserie1.png"
    ...
    private val serviceHolder = HostScopedService({ baseUrl }) { GuardaSerieService.build(baseUrl) }
