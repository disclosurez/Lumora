...
object AnyMovieProvider : Provider {
    ...
    override val logo: String get() = "$URL/wp-content/uploads/2023/08/AM-LOGO-1.png"
    override val language = "en"

    private var _wpsearch = ""

    // Rebuilt when the manifest repoints this site - see HostScopedService.
    private val serviceHolder = HostScopedService({ baseUrl }) { AllMoviesForYouService.build() }
