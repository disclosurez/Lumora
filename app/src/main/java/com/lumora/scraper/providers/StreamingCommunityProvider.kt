...
import com.lumora.scraper.utils.InertiaUtils
...
class StreamingCommunityProvider(private val _language: String? = null) : Provider {
    ...
    // DEFAULT_DOMAIN stays as the fallback: this provider rewrites the stored domain itself
    // when the site moves, and that can happen between manifest updates.
    override val baseUrl: String get() = ScraperHosts[name].ifBlank { DEFAULT_DOMAIN }
