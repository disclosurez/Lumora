...
import com.lumora.scraper.models.doramasflix.ApiResponse
...
object DoramasflixProvider : Provider {
    ...
    // Rebuilt when the manifest repoints this site - see HostScopedService.
    private val serviceHtmlHolder = HostScopedService({ baseUrl }) {
        Retrofit.Builder()
            .baseUrl(baseUrl)
    ...
    private val serviceHtml get() = serviceHtmlHolder.get()
