...
import com.lumora.scraper.models.Video.Server
...
object MStreamProvider : Provider {
    ...
    // Manifest first; currentBaseUrl() is this provider's own live-domain resolution, kept
    // as the fallback for a move that happens between manifest updates.
    override val baseUrl: String
        get() = ScraperHosts[name].ifBlank { currentBaseUrl() }
