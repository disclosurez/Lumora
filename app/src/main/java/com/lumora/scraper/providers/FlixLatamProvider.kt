...
import com.lumora.scraper.models.flixlatam.DataLinkItem
import com.lumora.scraper.models.flixlatam.PlayerResponse
// import com.lumora.scraper.utils.CryptoAES
...
object FlixLatamProvider : Provider {
    ...
    private val serviceHolder = HostScopedService({ baseUrl }) { FlixLatamService.build(baseUrl) }
