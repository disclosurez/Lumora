...
object FrenchAnimeProvider : Provider, ProviderConfigUrl {
    ...
    override val baseUrl: String
        get() {
            ...
            return cacheURL.ifEmpty { FrenchAnimeProvider.defaultBaseUrl }
        }
    ...
    // Built on first use - see AnimeWorldProvider for why object-init is too early now.
    private val serviceHolder = HostScopedService({ baseUrl }) { FrenchAnimeService.build() }
    ...
    override suspend fun onChangeUrl(forceRefresh: Boolean): String {
        changeUrlMutex.withLock {
            // Host changes are picked up by serviceHolder; nothing to reassign.
        }
        return baseUrl
    }
