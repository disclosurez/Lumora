...
object Altadefinizione01Provider : Provider {
    ...
    private val serviceHolder = HostScopedService({ baseUrl }) { Altadefinizione01Service.build(baseUrl) }
    ...
    override suspend fun getGenre(id: String, page: Int): Genre {
        ...
        val shows = doc.select("#dle-content .boxgrid.caption")
            .mapNotNull { el -> parseGridItem(el) as? com.lumora.scraper.models.Show }
