...
object MEGAKinoProvider : Provider {
    ...
    private val serviceHolder = HostScopedService({ baseUrl }) { MEGAKinoService.build(baseUrl) }
    ...
    override suspend fun getGenre(id: String, page: Int): Genre {
        ...
        return Genre(id, genreName, items.filterIsInstance<com.lumora.scraper.models.Show>())
    }
    ...
    override suspend fun getPeople(id: String, page: Int): People {
        ...
        val filmography = parseContentItems(document).filterIsInstance<com.lumora.scraper.models.Show>()
