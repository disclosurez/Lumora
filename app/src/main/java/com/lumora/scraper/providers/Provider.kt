...
interface Provider {
    ...
    companion object {
        ...
        val providers = mapOf(
            ...
            PlutoTvProvider("mx") to ProviderSupport(movies = false, tvShows = true),
            PlutoTvProvider("ar") to ProviderSupport(movies = false, tvShows = true),
            PlutoTvProvider("de") to ProviderSupport(movies = false, tvShows = true),
            PlutoTvProvider("es") to ProviderSupport(movies = false, tvShows = true),
            PlutoTvProvider("fr") to ProviderSupport(movies = false, tvShows = true),
            PlutoTvProvider("it") to ProviderSupport(movies = false, tvShows = true),
            PlutoTvProvider("us") to ProviderSupport(movies = false, tvShows = true),
